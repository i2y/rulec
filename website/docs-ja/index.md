...
エージェントが表を書き、rulec が証明して**直し方をそれを起こす入力つきで**返し、**道具では決められないことだけ**が人に届きます。人が答えるのは金額と丸めの向き — つまり業務の判断だけです。
...
大事なのは **③ の矢印**です。ふつうの道具は「分からなかった」を黙って通すか、それらしい既定値で埋めます。rulec は**そこで止まり、具体的な入力を一つ添えて人に渡します** — 「山梨県あての S60 の運賃はいくらですか」。人が答えられる形になっているので、往復が一回で済みます。
