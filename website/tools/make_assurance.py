...
JA = dict(
    ...
    cards=[
        ...
        ("4・5・6 — コードを見る", ["12 言語が一バイトずつ一致。網羅の六基準。", "モデル検査器は Rust を全入力で読む"], ("joint", 2), "accent"),
...
EN = dict(
    ...
    cards=[
        ...
        ("4, 5, 6 — the code", ["Twelve languages, byte for byte. Six", "coverage criteria. Rust over every input"], ("joint", 2), "accent"),
