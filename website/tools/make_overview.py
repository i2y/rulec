...
JA = dict(
    alt="表を書く。rulec は一行を入力の組み合わせの一区画にして並べ、隙間も重なりも無いことを"
        ...
        "依存ゼロの Python・TypeScript・JavaScript・Rust・Ruby・PHP・Go・Swift・Java・SQL・Wasm が出る。",
    ...
    langs=["Python・TypeScript・JavaScript・Rust・Ruby", "PHP・Go・Swift・Java・SQL・Wasm"],
...
EN = dict(
    alt="Write the table. rulec turns each row into a box in the input space and proves "
        ...
        "table generates, and what comes out is dependency-free Python, TypeScript, JavaScript, Rust, Ruby, PHP, Go, Swift, Java, SQL and Wasm.",
