...
EN = dict(
    ...
    code=("Python · TypeScript · Go",
          ["def fee(dest: Zone, weight: Gram) -> YenInclTax:",
           ...
           "    ...",
           "    return _round_up(fee, 10)"],
          ["zero dependencies, no engine, the same answer in all three"], ".py"),
