...
generates ordinary Python, TypeScript, Rust, Ruby, Go and Swift with no runtime to install.
...
by types and declarations, six languages out with zero dependencies, comparison against the
