...
Fee (0.21.0), re-checked against the Lean proofs
...
**Twelve targets** · **109 diagnostics** · **50 rules checked, generated and run on every commit — 22 transcribed from a published source** · **no dependencies, no runtime** · **one binary** · **the checks are offline**
