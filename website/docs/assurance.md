...
| **8. The repository's own tests** | 92 deliberately broken rules each produce the diagnostic they should; 46 rules are checked, generated and run on every commit | `cargo test` |
...
- **92 deliberately broken rules**, each producing the diagnostic it should — and the
