...
| **8. The repository's own tests** | 83 deliberately broken rules each produce the diagnostic they should; 33 rules are checked, generated and run on every commit | `cargo test` |
...
- **33 rules** — 28 transcribed from real published terms, 5 written to reach the corners of
