...
| **8. The repository's own tests** | 83 deliberately broken rules each produce the diagnostic they should; 43 rules are checked, generated and run on every commit | `cargo test` |
