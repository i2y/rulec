...
| **8. The repository's own tests** | 83 deliberately broken rules each produce the diagnostic they should; 39 rules are checked, generated and run on every commit | `cargo test` |
...
- **39 rules** — 32 transcribed from real published terms, 7 written to reach the corners of
