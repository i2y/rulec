...
Ruby, a final class in PHP, a record in Java, a struct in Rust, Swift and Go, one column
...
Ruby rounds toward −∞ while in Rust, Swift, Go, Java, TypeScript, JavaScript,
