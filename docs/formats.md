...
```json
{"v":1,"rule":"クーポン併用","alias":"coupon_stack","version":"1","source_sha256":"094dba24753a…","rulec":"0.21.0",
...
健康保険料 (kenpo_premium v1, sha256:5d4974d65bdb) — certificate by rulec 0.21.0
...
健康保険料 (0.21.0), re-checked against the Lean proofs
