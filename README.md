...
**M0 から M3 まで、四段すべて完成しています。** テスト 163 本、コーパス 7 本、診断は台帳の 30 項目すべて。
...
- **エージェントを第一の利用者に（2026-09）** — サブコマンドごとの `--help` と未知のフラグの拒否、診断台帳の単一ソース化と `rulec explain`、診断 JSON v2（証人と直し方をデータで持つ）と `--terse`、全コマンドの `--format json`、生成物の呼び方の目録 `rulec api`、そして `AGENTS.md` と `docs/`
