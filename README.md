...
**M0 から M3 まで、四段すべて完成しています。** テスト 190 本、コーパス 11 本、診断は台帳の 33 項目すべて。
...
いま対応しているのは **Python・TypeScript・Go** の三つで、**Java・Kotlin・Swift・SQL に対応予定**です。
