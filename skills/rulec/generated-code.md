...
a flag because it is the one pass whose cost is noticeable: on the corpus of 47 rules it
adds about 175 seconds to a run that otherwise takes seconds. `rulec api` names
