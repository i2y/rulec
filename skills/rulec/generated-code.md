...
a flag because it is the one pass whose cost is noticeable: on the corpus of 31 rules it
adds about 145 seconds to a run that otherwise takes seconds. `rulec api` names
